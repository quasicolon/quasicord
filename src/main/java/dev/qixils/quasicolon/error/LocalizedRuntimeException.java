...
public class LocalizedRuntimeException extends RuntimeException implements LocalizableText {
	...
	public LocalizedRuntimeException(@NonNull TranslationProvider translationProvider, @NonNull String key, String @Nullable ... args) {
		this.translationProvider = translationProvider;
		this.key = Objects.requireNonNull(key, "key");
		this.args = Objects.requireNonNullElseGet(args, () -> new String[0]);
	}

	public LocalizedRuntimeException(TranslationProvider.@NonNull Type translationProviderType, @NonNull String key, String @Nullable ... args) {
